...
extern "C" void app_main()
{
    ...
    // This lamp has no datasheet CCT range -- 2700K-6500K is a conventional
    // choice, matching app_driver.cpp's LAMP_MIREDS_MIN/MAX.
    light_config.color_control_color_temperature.color_temp_physical_min_mireds = 154;
    light_config.color_control_color_temperature.color_temp_physical_max_mireds = 370;
    ...
    /* Mark deferred persistence for attributes that might be changed rapidly (e.g. a slider) */
